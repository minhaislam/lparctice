...
Route::group(['middleware' => ['sess']], function () {
    Route::get('/admin', 'AdminController@index')->name('admin.index')->middleware('user.type.validation');
    ...
    //Scout:
    Route::get('/scout', 'ScoutController@index')->name('scout.index')->middleware('user.type.validation');
    ...
    //User:
    Route::get('/user', 'UserController@index')->name('user.index')->middleware('user.type.validation');
